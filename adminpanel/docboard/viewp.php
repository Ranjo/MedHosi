    ...
    <div class="w3-container" style="margin-top:20px; " >
      <div class="card card-primary w3-theme-light">
       ...
       <div class="input-container">
        <input type="text" class="input-field"  onkeyup="myFunction()" placeholder="Search" id="myInput" name="filterdoc" style=" width: 100%; height: 50px;"><i class="fa fa-search icon fa-1x" style="font-size: 20px;"></i>
      </div> 
      <?php
