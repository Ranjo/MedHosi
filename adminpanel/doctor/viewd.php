...
<body class="w3-theme-l4">
      ...
      <nav class="w3-sidebar sidebar skin-black w3-theme-l4s " id="linkhov" style="z-index:3;width:300px; color: white; font-size: 14px; background-color: #1a2226;">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="viewd.php"><i class="fa fa-circle-o"></i> View Doctors</a></li>
...
<div class="w3-main w3-theme-l4 " style="margin-left:300px;margin-top: 115px; ">
    ...
    <!-- Header -->
    <!-- <header class="w3-container   w3-main  w3-theme-l2" style="padding-top:30px; margin-top: 0px;">
      <h5><b><i class="fa fa-dashboard"></i> My Dashboard</b></h5>
    </header> -->

    <!-- Header -->
    <header class="w3-container w3-main w3-theme-d2 " style="padding-top:50px">
      <h5><b><i class="fa fa-dashboard"></i> Doctors</b></h5>
    </header>
    ...
    <div class="w3-container" style="margin-top:20px; " >
      ...
      <div class="w3-containers">
        <input type="text"  onkeyup="myFunction()" placeholder="Search" id="myInput" name="filterdoc" style=" width: 60%; height: 50px;">
      </div> 
      <?php
      require '../../config/dbconfig.php';

      $sql="SELECT * FROM docotor";
      $result = mysqli_query($conn,$sql);
?>
      <table id="myTable" class="table table-condensed w3-striped w3-bordered w3-border w3-hoverable w3-theme-l5" style="">
      <tr class="success">
      <th>Doctor Id</th>
      <th>surname</th>
      <th>firstname</th>  
