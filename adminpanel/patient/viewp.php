...
<body>
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="viewp.php"><i class="fa fa-circle-o"></i> View Patient</a></li>
...
<div class="w3-main w3-theme-l4 " style="margin-left:300px;margin-top: 115px; ">
    ...
    <!-- Header -->
    <header class="w3-container   w3-main  w3-theme-l2" style="padding-top:30px; margin-top: 0px;  position: sticky; top: 0;">
    ...
    <div class="w3-container" style="margin-top:20px; " >
      <div class="card card-primary w3-theme-light">
       ...
       <div class="w3-containers">
        <input type="text" class="w3-input"  onkeyup="myFunction()" placeholder="Search" id="myInput" name="filterdoc" style=" width: 100%; height: 50px;"><i class="fa fa-search"></i>
      </div> 
      <?php
      require '../../config/viewp.php';
      ?>
    </div>
  </div>
</div>
