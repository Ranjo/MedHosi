...
<body class="w3-theme-l5 ">
  ...
  <div class="w3-top " style="margin-left: 300px; width:79% ">
    ...
    <div class="w3-bar w3-text-white w3-large" style="z-index:4; width: 99%; background-color: #1e2226; opacity: 0.9;">
  ...
  <nav class="w3-sidebar sidebar skin-black w3-theme-l4s " id="linkhov" style="z-index:3;width:300px; color: white; font-size: 14px; background-color: #1a2226;">
    <div style="height:  115px; background-color: #1a2226; font-family: sans-serif; " class="w3-text-white">
      <div class="w3-container w3-padding "style="border-bottom:  1px solid white;">
        ...
        <h7 class="w3-right w3-wide " style="padding-bottom: 10px;">Panel</h7>
      </div>
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="doctor/doc.php"><i class="fa fa-circle-o fa-fw"></i> Add Doctor<i class="fa fa-cross"></i></a></li>
            <li><a href="doctor/viewd.php"><i class="fa fa-circle-o fa-fw"></i> View Doctors</a></li>
            <li><a href="doctor/viewR.php"><i class="fa fa-circle-o fa-fw"></i> Reports</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="patient/pat.php"><i class="fa fa-circle-o fa-fw"></i>Add Patient</a></li>
            <li><a href="patient/viewp.php"><i class="fa fa-circle-o fa-fw"></i> View Patient</a></li>
            <li><a href="patient/patR.php"><i class="fa fa-circle-o fa-fw"></i> Reports</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="hospital/addhos.php"><i class="fa fa-circle-o fa-fw"></i> Add Hospital</a></li>
            <li><a href="hospital/viewh.php"><i class="fa fa-circle-o fa-fw"></i> View Hospital</a></li>
            <li><a href="hospital/hosR.php"><i class="fa fa-circle-o fa-fw"></i> Reports</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="notice/invoice.html"><i class="fa fa-circle-o fa-fw"></i> Create Notices</a></li>
            <li><a href="notice/profile.html"><i class="fa fa-circle-o fa-fw"></i> View Notieces</a></li>
  ...
  <div class="w3-main w3-theme-l4 " style="margin-left:300px;margin-top: 109px; ">
    ...
    <!-- Header -->
    <header class="w3-container w3-text-white  w3-main" style="padding-top:10px; background-color: #1e2224; opacity: 0.5;">
