...
<body class="w3-theme-l5 ">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="../doctor/doc.php"><i class="fa fa-circle-o"></i> Add Doctor<i class="fa fa-cross"></i></a></li>
          <li><a href="../doctor/viewd.php"><i class="fa fa-circle-o"></i> View Doctors</a></li>
          <li><a href="../doctor/viewR.php"><i class="fa fa-circle-o"></i> Reports</a></li>
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          <li><a href="addhos.php"><i class="fa fa-circle-o"></i> Add Hospital</a></li>
          <li class="active"><a href="viewh.php"><i class="fa fa-circle-o"></i> View Hospital</a></li>
          <li><a href="hosR.php"><i class="fa fa-circle-o"></i> Reports</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="../notice/invoice.html"><i class="fa fa-circle-o"></i> Create Notices</a></li>
          <li><a href="../notice/profile.html"><i class="fa fa-circle-o"></i> View Notieces</a></li>
...
<div class="w3-main w3-theme-l4 " style="margin-left:300px;margin-top: 115px; ">
    ...
    <!-- Header -->
    <header class="w3-container   w3-main  w3-theme-l2" style="padding-top:10px; margin-top: 0px;">
